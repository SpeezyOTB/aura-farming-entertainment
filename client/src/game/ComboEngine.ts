  ...
  kai: [
    {
      ...
      requiresGround: true,
      steps: [
        { type: 'punch',    delay: 0,    label: 'jab 1' },
        { type: 'punch',    delay: 0.13, label: 'jab 2' },
        { type: 'punch',    delay: 0.13, label: 'jab 3' },
        { type: 'airkick',  delay: 0.18, damage: 5, vyBoost: -120, label: 'aerial roundhouse' },
      ],
    },
    {
      name: 'kai-sweep',
      ...
      requiresGround: true,
      steps: [
        { type: 'punch', delay: 0,    label: 'double jab 1' },
        { type: 'punch', delay: 0.13, label: 'double jab 2' },
        { type: 'sweep', delay: 0.18, damage: 3, label: 'sweep' },
      ],
    },
    {
      name: 'aerial-karate-kick',
      inputs: ['jump', 'kick'],
      windowMs: 800,
      requiresAir: true,
      steps: [
        { type: 'airkick', delay: 0, damage: 5, vyBoost: -60, label: 'aerial karate kick' },
      ],
    },
    {
      ...
      requiresGround: true,
      steps: [
        { type: 'kick', delay: 0,    label: 'spin 1' },
        { type: 'kick', delay: 0.18, damage: 5, label: 'spin 2' },
      ],
    },
    {
